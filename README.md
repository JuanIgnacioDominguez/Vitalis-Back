...
![Spring Boot](https://img.shields.io/badge/Spring%20Boot-3.4.4-6DB33F?style=flat&logo=spring)
![Java](https://img.shields.io/badge/Java-17-007396?style=flat&logo=openjdk)
![MySQL](https://img.shields.io/badge/MySQL-8.0-4479A1?style=flat&logo=mysql)
![JWT](https://img.shields.io/badge/JWT-secure-000000?style=flat&logo=jsonwebtokens)
![Maven](https://img.shields.io/badge/Maven-3.x-C71A36?style=flat&logo=apache-maven)

API RESTful para gestionar usuarios, profesionales, turnos, favoritos, notificaciones y calificaciones de la app. Incluye autenticación JWT, recordatorios por email, manejo de fotos de perfil y top de profesionales más favoriteados.
...
## 📝 Descripción
Vitalis digitaliza la gestión de turnos médicos:
- Registro/login con verificación por código y JWT
- Búsqueda de profesionales por especialidad y favoritos
- Reserva de turnos con validación de obra social
- Recordatorios y notificaciones por email
- Foto de perfil en BD y calificación única de la app

---

## 🧰 Stack
- **Backend:** Spring Boot (Web, Security, Data JPA, Mail, Actuator)
- **Seguridad:** JWT + BCrypt
- **Base de datos:** MySQL 8, Hibernate
- **Build:** Maven Wrapper
- **Runtime:** Java 17
- **Infra:** Dockerfile listo; opcional Compose
...
# 2) Configurar MySQL
# crea la base y credenciales (ver tabla de config)
...
### Variables claves (application.properties)
```properties
server.port=4002
